      ...
      <div className={homeStyles.homeWrapper}>
        <div className={homeStyles.textContainerLeft}>
          <p>
            ...
            j'ai fini par répondre à l'appel du web en me lançant dans une formation de développement web en 2022. Internet étant désormais un lieu de vie incontournable pour l'écrit, cette évolution était logique et nécessaire.
          </p>
        </div>
        <img
          ref={imgRef}
